...
## Get a different basemap

See `?get_map` to get available options.
For example, `stamen watercolor` basemap

```{r, eval=F}
sf_basemap2 <- get_map(sf_ctr, zoom=12, scale=1, 
...
Recreate the earlier facet map of `sfhomes2010_15` with ggmap

1. Use `get_map` to fetch the `stamen toner-lite` map tiles.

2. Use `ggmap` to create the facet map
...
**popup.vars = 
      c("SalesYear","totvalue","NumBedrooms","NumBathrooms","AreaSquareFeet")**
