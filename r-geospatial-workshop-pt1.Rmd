...
Relatively easy to create interactive `leaflet` maps
...
Use the command `tmap_mode`("<mode>") to toggle between them.
...
Comine `tm_shape(<sp_object>)`  to specifiy a geospatial data layer
...
```{r}
tm_shape(sfhomes15_sp) + 
  tm_dots(col="totvalue", size=.25) # col names must be quoted!
```
...
save_layers <- c("sfhomes15_sp", "sfboundary_lonlat", 
                 "highways_lonlat", "bart", "landmarks")
