...
```{r}
tm_shape(us_states_5070) + tm_polygons(col="POPULATION", palette="BuPu")
```
...
```{r}
tm_shape(us_states_5070) + tm_polygons(col="POPULATION", palette="Spectral", 
...
```{r}
tm_shape(us_states_5070) + tm_polygons(col="POPULATION", style="quantile")
```
...
```{r}
tm_shape(us_states_5070) + tm_polygons(col=c("POPULATION","popdens"), 
                              style=c("jenks","jenks"))
```
...
```{r, echo=F}
  ...
  tm_shape(us_states_5070) + tm_squares(col="popdens", style="jenks")
```
...
```{r}
tm_shape(us_states_5070) + tm_polygons(col="white", border.alpha = 0.5) + 
  tm_shape(us_states_5070) + tm_symbols(size="popdens", style="jenks")
```
...
```{r, eval=F}
tm_shape(us_states_5070) + tm_polygons(col="white", border.alpha = 0.5) + 
  tm_shape(us_states_5070) + tm_symbols(size="popdens", style="sd", 
...
```{r, eval=F}
tm_shape(us_states_5070 ) + tm_polygons("POPULATION") + 
