...
greenspace = extract(nlcd_green, tracts, fun=mean)
...
#and check that the projections are all good
...
#and add that as a column in our sfhomes15_utm dataframe too
...
# SECTION II: RasterStacks and RasterBricks
